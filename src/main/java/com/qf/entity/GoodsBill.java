...
public class GoodsBill {
    ...
    public GoodsBill(String goodsBillCode, String sendGoodsCustomerNo, String sendGoodsCustomer, String sendGoodsCustomerTel, String sendGoodsCustomerAddr, String receiveGoodsCustomerCode, String receiveGoodsCustomer, String receiveGoodsCustomerTel, String receiveGoodsCustomerAddr, Date sendGoodsDate, String sendGoodsAddr, String receiveGoodsAddr, Date predeliveryDate, Date factDealDate, double helpAcceptPayment, String acceptProcedureRate, String payMode, String fetchGoodsMode, String writeBillPerson, Date writeDate, boolean validity, boolean ifAudit, boolean ifSettleAccounts, String transferStation, double transferFee, double reduceFund, double payKickback, double moneyOfChangePay, double carryGoodsFee, double carriage, double insurance, String employeeCode, String remark, String acceptStation) {
        this.goodsBillCode = goodsBillCode;
        this.sendGoodsCustomerNo = sendGoodsCustomerNo;
        this.sendGoodsCustomer = sendGoodsCustomer;
        this.sendGoodsCustomerTel = sendGoodsCustomerTel;
